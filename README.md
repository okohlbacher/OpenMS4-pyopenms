...
`pyopenms` builds against the installed **core**, **test-data**, **prose**, **flash** packages at the revisions recorded in [`dependencies.lock.json`](dependencies.lock.json). **flashapp** builds against it.
...
| [OpenMS4-prose](https://github.com/okohlbacher/OpenMS4-prose) | dependency | ProSE and the OpenMS::ProSE backend |
