...
# s is "EM[UNIMOD:35]K"
        ...
        .def_static("tryGetMonoWeight", [](const OpenMS::ProForma::Peptidoform& pf) -> std::optional<double> { return OpenMS::ProForma::tryGetMonoWeight(pf); }, "pf"_a, "Monoisotopic mass of a Peptidoform in Daltons, or None when it cannot be calculated")
        .def_static("tryGetMonoWeight", [](const OpenMS::ProForma::PeptidoformIon& pfi) -> std::optional<double> { return OpenMS::ProForma::tryGetMonoWeight(pfi); }, "pfi"_a, "Monoisotopic mass of a PeptidoformIon in Daltons, or None when it cannot be calculated")
...
:param tags: The vector of tags, that is filled with this function
    ...
    // PeptidoformIon overloads: the cross-linked (//) chemistry is only reachable through these
    m.def("__static_ProForma_canCalculateMass", [](const OpenMS::ProForma::PeptidoformIon& pfi) -> bool { return OpenMS::ProForma::canCalculateMass(pfi); }, "pfi"_a);
    m.def("__static_ProForma_getMassCalculationIssues", [](const OpenMS::ProForma::PeptidoformIon& pfi) -> std::vector<OpenMS::ProForma::ConversionIssue> { return OpenMS::ProForma::getMassCalculationIssues(pfi); }, "pfi"_a);
    m.def("__static_ProForma_getMonoWeight", [](const OpenMS::ProForma::PeptidoformIon& pfi) -> double { return OpenMS::ProForma::getMonoWeight(pfi); }, "pfi"_a);
    m.def("__static_ProForma_tryGetMonoWeight", [](const OpenMS::ProForma::Peptidoform& pf) -> std::optional<double> { return OpenMS::ProForma::tryGetMonoWeight(pf); }, "pf"_a);
    m.def("__static_ProForma_tryGetMonoWeight", [](const OpenMS::ProForma::PeptidoformIon& pfi) -> std::optional<double> { return OpenMS::ProForma::tryGetMonoWeight(pfi); }, "pfi"_a);
    m.def("__static_ProForma_canGenerateSpectrum", [](const OpenMS::ProForma::PeptidoformIon& pfi) -> bool { return OpenMS::ProForma::canGenerateSpectrum(pfi); }, "pfi"_a);
    m.def("__static_ProForma_getSpectrumGenerationIssues", [](const OpenMS::ProForma::PeptidoformIon& pfi) -> std::vector<OpenMS::ProForma::ConversionIssue> { return OpenMS::ProForma::getSpectrumGenerationIssues(pfi); }, "pfi"_a);
    m.def("__static_ProForma_generateSpectrum", [](const OpenMS::ProForma::PeptidoformIon& pfi, int min_charge, int max_charge, const std::string& ion_types, bool add_losses, bool add_metainfo) -> OpenMS::MSSpectrum { return OpenMS::ProForma::generateSpectrum(pfi, min_charge, max_charge, ion_types, add_losses, add_metainfo); }, "pfi"_a, "min_charge"_a, "max_charge"_a, "ion_types"_a, "add_losses"_a, "add_metainfo"_a);
